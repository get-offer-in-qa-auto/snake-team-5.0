...
Period: **7 UTC calendar days** (2026-09-19T00:00:00+00:00 — 2026-09-25T08:57:36+00:00).
...
|---|---:|---:|---|---|
| Average Pass Rate | 98.70% | >= 98.00% | OK | average pass rate = (98.70 + 100.00 + 98.70 + 97.40 + 98.70 + 100.00 + 97.40) / 7 = 98.70% |
| Average Fail Rate | 1.30% | <= 2.00% | OK | average fail rate = (1.30 + 0.00 + 1.30 + 2.60 + 1.30 + 0.00 + 2.60) / 7 = 1.30% |
...
| Average UI Flaky Rate | 2.12% | <= 2.00% | Failed | average UI flaky rate = (0.00 + 0.00 + 3.70 + 3.70 + 3.70 + 0.00 + 3.70) / 7 = 2.12% |
...
| Average UI Test Duration | 10.13s | <= 12.00s | OK | average UI test duration = (9.14 + 10.95 + 8.99 + 10.41 + 11.04 + 10.42 + 10.00) / 7 = 10.13s |
| Average API Test Duration | 1.36s | <= 1.50s | OK | average API test duration = (1.36 + 1.41 + 1.42 + 1.30 + 1.42 + 1.40 + 1.21) / 7 = 1.36s |
| Total UI Test Time | 273.62s | <= 300.00s | OK | total UI test time = (246.65 + 295.55 + 242.79 + 280.96 + 298.04 + 281.38 + 269.98) / 7 = 273.62s |
| Average API Test Run Duration | 67.98s | <= 75.00s | OK | average API run duration = (68.04 + 70.55 + 70.92 + 64.92 + 70.88 + 69.78 + 60.74) / 7 = 67.98s |
| Average Pipeline Duration | 319.14s | <= 360.00s | OK | average pipeline duration = (281.00 + 267.00 + 278.00 + 259.00 + 534.00 + 327.00 + 288.00) / 7 = 319.14s |
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| Chromium | 96.83% | 2 | 0.00% | 8.67s | <= 11.00s | 23.20s | 91.59s | <= 100.00s | Failed |
| Firefox | 93.65% | 4 | 6.35% | 10.56s | <= 13.00s | 24.38s | 103.47s | <= 115.00s | Failed |
| WebKit | 100.00% | 0 | 0.00% | 11.17s | <= 14.00s | 29.31s | 104.97s | <= 120.00s | OK |
