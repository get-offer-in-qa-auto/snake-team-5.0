...
Period: **7 UTC calendar days** (2026-08-27T00:00:00+00:00 — 2026-09-02T06:58:01+00:00).
...
|---|---:|---:|---|---|
| Average Pass Rate | 98.52% | >= 98.00% | OK | average pass rate = (100.00 + 98.70 + 96.10 + 100.00 + 97.40 + 97.40 + 100.00) / 7 = 98.52% |
| Average Fail Rate | 1.48% | <= 2.00% | OK | average fail rate = (0.00 + 1.30 + 3.90 + 0.00 + 2.60 + 2.60 + 0.00) / 7 = 1.48% |
...
| Average UI Flaky Rate | 2.12% | <= 2.00% | Failed | average UI flaky rate = (0.00 + 0.00 + 3.70 + 0.00 + 3.70 + 7.41 + 0.00) / 7 = 2.12% |
...
| Average UI Test Duration | 9.85s | <= 12.00s | OK | average UI test duration = (9.55 + 10.18 + 9.95 + 9.65 + 10.17 + 10.03 + 9.43) / 7 = 9.85s |
| Average API Test Duration | 1.42s | <= 1.50s | OK | average API test duration = (1.41 + 1.41 + 1.36 + 1.41 + 1.53 + 1.42 + 1.41) / 7 = 1.42s |
| Total UI Test Time | 265.97s | <= 300.00s | OK | total UI test time = (257.78 + 274.93 + 268.70 + 260.48 + 274.57 + 270.78 + 254.54) / 7 = 265.97s |
| Average API Test Run Duration | 71.04s | <= 75.00s | OK | average API run duration = (70.49 + 70.42 + 68.11 + 70.34 + 76.51 + 70.88 + 70.52) / 7 = 71.04s |
| Average Pipeline Duration | 309.71s | <= 360.00s | OK | average pipeline duration = (269.00 + 315.00 + 334.00 + 297.00 + 341.00 + 308.00 + 304.00) / 7 = 309.71s |
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| Chromium | 93.65% | 4 | 3.17% | 9.69s | <= 11.00s | 24.26s | 95.62s | <= 100.00s | Failed |
| Firefox | 98.41% | 1 | 0.00% | 9.88s | <= 13.00s | 22.93s | 105.57s | <= 115.00s | OK |
| WebKit | 95.24% | 3 | 3.17% | 9.98s | <= 14.00s | 27.66s | 109.70s | <= 120.00s | Failed |
