...
Period: **7 UTC calendar days** (2026-08-01T00:00:00+00:00 — 2026-08-07T04:32:11+00:00).
...
|---|---:|---:|---|---|
| Average Pass Rate | 99.44% | >= 98.00% | OK | average pass rate = (98.70 + 100.00 + 98.70 + 100.00 + 100.00 + 98.70 + 100.00) / 7 = 99.44% |
| Average Fail Rate | 0.56% | <= 2.00% | OK | average fail rate = (1.30 + 0.00 + 1.30 + 0.00 + 0.00 + 1.30 + 0.00) / 7 = 0.56% |
...
| Average UI Test Duration | 10.59s | <= 12.00s | OK | average UI test duration = (9.75 + 8.87 + 10.84 + 11.49 + 11.26 + 11.01 + 10.93) / 7 = 10.59s |
| Average API Test Duration | 1.39s | <= 1.50s | OK | average API test duration = (1.38 + 1.40 + 1.44 + 1.37 + 1.39 + 1.38 + 1.40) / 7 = 1.39s |
| Total UI Test Time | 285.99s | <= 300.00s | OK | total UI test time = (263.21 + 239.38 + 292.62 + 310.23 + 304.10 + 297.15 + 295.23) / 7 = 285.99s |
| Average API Test Run Duration | 69.67s | <= 75.00s | OK | average API run duration = (68.81 + 70.07 + 71.96 + 68.45 + 69.74 + 68.82 + 69.81) / 7 = 69.67s |
| Average Pipeline Duration | 336.86s | <= 360.00s | OK | average pipeline duration = (290.00 + 284.00 + 313.00 + 298.00 + 312.00 + 571.00 + 290.00) / 7 = 336.86s |
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| Chromium | 96.83% | 2 | 0.00% | 9.67s | <= 11.00s | 24.13s | 94.93s | <= 100.00s | Failed |
| Firefox | 98.41% | 1 | 0.00% | 11.08s | <= 13.00s | 25.34s | 109.32s | <= 115.00s | OK |
| WebKit | 100.00% | 0 | 0.00% | 11.02s | <= 14.00s | 28.66s | 109.66s | <= 120.00s | OK |
