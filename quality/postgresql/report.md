...
Period: **7 UTC calendar days** (2026-08-10T00:00:00+00:00 — 2026-08-16T04:05:01+00:00).
...
|---|---:|---:|---|---|
| Average Pass Rate | 99.07% | >= 98.00% | OK | average pass rate = (97.40 + 100.00 + 100.00 + 98.70 + 98.70 + 100.00 + 98.70) / 7 = 99.07% |
| Average Fail Rate | 0.93% | <= 2.00% | OK | average fail rate = (2.60 + 0.00 + 0.00 + 1.30 + 1.30 + 0.00 + 1.30) / 7 = 0.93% |
...
| Average UI Test Duration | 10.30s | <= 12.00s | OK | average UI test duration = (10.82 + 8.53 + 11.96 + 9.96 + 9.84 + 11.04 + 9.95) / 7 = 10.30s |
| Average API Test Duration | 1.28s | <= 1.50s | OK | average API test duration = (0.60 + 1.40 + 1.36 + 1.34 + 1.42 + 1.41 + 1.40) / 7 = 1.28s |
| Total UI Test Time | 278.12s | <= 300.00s | OK | total UI test time = (292.16 + 230.26 + 322.90 + 269.06 + 265.76 + 297.96 + 268.78) / 7 = 278.12s |
| Average API Test Run Duration | 63.83s | <= 75.00s | OK | average API run duration = (30.12 + 69.91 + 67.85 + 66.89 + 71.24 + 70.69 + 70.12) / 7 = 63.83s |
| Average Pipeline Duration | 289.14s | <= 360.00s | OK | average pipeline duration = (281.00 + 301.00 + 289.00 + 305.00 + 276.00 + 280.00 + 292.00) / 7 = 289.14s |
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| Chromium | 100.00% | 0 | 0.00% | 9.30s | <= 11.00s | 23.75s | 93.87s | <= 100.00s | OK |
| Firefox | 98.41% | 1 | 0.00% | 10.64s | <= 13.00s | 25.03s | 105.23s | <= 115.00s | OK |
| WebKit | 96.83% | 2 | 0.00% | 10.96s | <= 14.00s | 28.04s | 113.98s | <= 120.00s | Failed |
