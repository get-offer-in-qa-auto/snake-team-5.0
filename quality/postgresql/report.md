...
Period: **7 UTC calendar days** (2026-08-30T00:00:00+00:00 — 2026-09-05T07:45:47+00:00).
...
|---|---:|---:|---|---|
| Average Pass Rate | 98.89% | >= 98.00% | OK | average pass rate = (100.00 + 97.40 + 97.40 + 100.00 + 100.00 + 100.00 + 97.40) / 7 = 98.89% |
| Average Fail Rate | 1.11% | <= 2.00% | OK | average fail rate = (0.00 + 2.60 + 2.60 + 0.00 + 0.00 + 0.00 + 2.60) / 7 = 1.11% |
...
| Average UI Flaky Rate | 2.65% | <= 2.00% | Failed | average UI flaky rate = (0.00 + 3.70 + 7.41 + 0.00 + 0.00 + 0.00 + 7.41) / 7 = 2.65% |
...
| Average UI Test Duration | 9.69s | <= 12.00s | OK | average UI test duration = (9.65 + 10.17 + 10.03 + 9.43 + 10.72 + 9.70 + 8.17) / 7 = 9.69s |
| Average API Test Duration | 1.41s | <= 1.50s | OK | average API test duration = (1.41 + 1.53 + 1.42 + 1.41 + 1.39 + 1.31 + 1.37) / 7 = 1.41s |
| Total UI Test Time | 261.76s | <= 300.00s | OK | total UI test time = (260.48 + 274.57 + 270.78 + 254.54 + 289.56 + 261.89 + 220.50) / 7 = 261.76s |
| Average API Test Run Duration | 70.29s | <= 75.00s | OK | average API run duration = (70.34 + 76.51 + 70.88 + 70.52 + 69.71 + 65.46 + 68.63) / 7 = 70.29s |
| Average Pipeline Duration | 309.00s | <= 360.00s | OK | average pipeline duration = (297.00 + 341.00 + 308.00 + 304.00 + 329.00 + 282.00 + 302.00) / 7 = 309.00s |
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| Chromium | 98.41% | 1 | 1.59% | 9.76s | <= 11.00s | 23.84s | 94.06s | <= 100.00s | OK |
| Firefox | 96.83% | 2 | 1.59% | 9.73s | <= 13.00s | 21.48s | 103.56s | <= 115.00s | Failed |
| WebKit | 95.24% | 3 | 4.76% | 9.59s | <= 14.00s | 27.39s | 110.63s | <= 120.00s | Failed |
