...
Period: **7 UTC calendar days** (2026-08-07T00:00:00+00:00 — 2026-08-13T05:14:34+00:00).
...
|---|---:|---:|---|---|
| Average Pass Rate | 99.44% | >= 98.00% | OK | average pass rate = (100.00 + 100.00 + 100.00 + 97.40 + 100.00 + 100.00 + 98.70) / 7 = 99.44% |
| Average Fail Rate | 0.56% | <= 2.00% | OK | average fail rate = (0.00 + 0.00 + 0.00 + 2.60 + 0.00 + 0.00 + 1.30) / 7 = 0.56% |
...
| Average UI Test Duration | 10.27s | <= 12.00s | OK | average UI test duration = (10.93 + 9.70 + 10.00 + 10.82 + 8.53 + 11.96 + 9.96) / 7 = 10.27s |
| Average API Test Duration | 1.26s | <= 1.50s | OK | average API test duration = (1.40 + 1.38 + 1.38 + 0.60 + 1.40 + 1.36 + 1.34) / 7 = 1.26s |
| Total UI Test Time | 277.34s | <= 300.00s | OK | total UI test time = (295.23 + 261.77 + 270.02 + 292.16 + 230.26 + 322.90 + 269.06) / 7 = 277.34s |
| Average API Test Run Duration | 63.19s | <= 75.00s | OK | average API run duration = (69.81 + 68.92 + 68.84 + 30.12 + 69.91 + 67.85 + 66.89) / 7 = 63.19s |
| Average Pipeline Duration | 290.57s | <= 360.00s | OK | average pipeline duration = (290.00 + 288.00 + 280.00 + 281.00 + 301.00 + 289.00 + 305.00) / 7 = 290.57s |
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| Chromium | 100.00% | 0 | 0.00% | 9.07s | <= 11.00s | 22.63s | 93.34s | <= 100.00s | OK |
| Firefox | 100.00% | 0 | 0.00% | 10.85s | <= 13.00s | 23.25s | 108.17s | <= 115.00s | OK |
| WebKit | 98.41% | 1 | 0.00% | 10.90s | <= 14.00s | 27.42s | 113.41s | <= 120.00s | OK |
