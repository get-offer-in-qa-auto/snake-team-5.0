...
Period: **7 UTC calendar days** (2026-09-04T00:00:00+00:00 — 2026-09-10T07:09:46+00:00).
...
|---|---:|---:|---|---|
| Average Pass Rate | 98.14% | >= 98.00% | OK | average pass rate = (100.00 + 97.40 + 100.00 + 96.10 + 98.70 + 97.40 + 97.40) / 7 = 98.14% |
| Average Fail Rate | 1.86% | <= 2.00% | OK | average fail rate = (0.00 + 2.60 + 0.00 + 3.90 + 1.30 + 2.60 + 2.60) / 7 = 1.86% |
...
| Average UI Flaky Rate | 2.12% | <= 2.00% | Failed | average UI flaky rate = (0.00 + 7.41 + 0.00 + 0.00 + 0.00 + 0.00 + 7.41) / 7 = 2.12% |
...
| Average UI Test Duration | 9.58s | <= 12.00s | OK | average UI test duration = (9.70 + 8.17 + 9.50 + 10.56 + 9.27 + 9.23 + 10.65) / 7 = 9.58s |
| Average API Test Duration | 1.36s | <= 1.50s | OK | average API test duration = (1.31 + 1.37 + 1.42 + 1.07 + 1.49 + 1.38 + 1.44) / 7 = 1.36s |
| Total UI Test Time | 258.71s | <= 300.00s | OK | total UI test time = (261.89 + 220.50 + 256.48 + 285.05 + 250.21 + 249.18 + 287.67) / 7 = 258.71s |
| Average API Test Run Duration | 67.81s | <= 75.00s | OK | average API run duration = (65.46 + 68.63 + 71.09 + 53.71 + 74.52 + 69.02 + 72.21) / 7 = 67.81s |
| Average Pipeline Duration | 300.00s | <= 360.00s | OK | average pipeline duration = (282.00 + 302.00 + 306.00 + 305.00 + 277.00 + 317.00 + 311.00) / 7 = 300.00s |
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| Chromium | 96.83% | 2 | 0.00% | 8.58s | <= 11.00s | 21.55s | 93.10s | <= 100.00s | Failed |
| Firefox | 95.24% | 3 | 3.17% | 10.00s | <= 13.00s | 25.13s | 104.54s | <= 115.00s | Failed |
| WebKit | 96.83% | 2 | 3.17% | 10.17s | <= 14.00s | 25.94s | 115.63s | <= 120.00s | Failed |
