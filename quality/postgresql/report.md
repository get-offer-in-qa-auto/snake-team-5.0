...
Period: **7 UTC calendar days** (2026-09-17T00:00:00+00:00 — 2026-09-23T08:43:01+00:00).
...
|---|---:|---:|---|---|
| Average Pass Rate | 98.89% | >= 98.00% | OK | average pass rate = (100.00 + 98.70 + 98.70 + 100.00 + 98.70 + 97.40 + 98.70) / 7 = 98.89% |
| Average Fail Rate | 1.11% | <= 2.00% | OK | average fail rate = (0.00 + 1.30 + 1.30 + 0.00 + 1.30 + 2.60 + 1.30) / 7 = 1.11% |
...
| Average UI Flaky Rate | 2.12% | <= 2.00% | Failed | average UI flaky rate = (0.00 + 3.70 + 0.00 + 0.00 + 3.70 + 3.70 + 3.70) / 7 = 2.12% |
...
| Average UI Test Duration | 10.26s | <= 12.00s | OK | average UI test duration = (10.71 + 10.58 + 9.14 + 10.95 + 8.99 + 10.41 + 11.04) / 7 = 10.26s |
| Average API Test Duration | 1.39s | <= 1.50s | OK | average API test duration = (1.41 + 1.43 + 1.36 + 1.41 + 1.42 + 1.30 + 1.42) / 7 = 1.39s |
| Total UI Test Time | 276.96s | <= 300.00s | OK | total UI test time = (289.07 + 285.67 + 246.65 + 295.55 + 242.79 + 280.96 + 298.04) / 7 = 276.96s |
| Average API Test Run Duration | 69.56s | <= 75.00s | OK | average API run duration = (70.32 + 71.29 + 68.04 + 70.55 + 70.92 + 64.92 + 70.88) / 7 = 69.56s |
| Average Pipeline Duration | 313.86s | <= 360.00s | OK | average pipeline duration = (257.00 + 321.00 + 281.00 + 267.00 + 278.00 + 259.00 + 534.00) / 7 = 313.86s |
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| Chromium | 96.83% | 2 | 0.00% | 9.12s | <= 11.00s | 24.77s | 91.59s | <= 100.00s | Failed |
| Firefox | 93.65% | 4 | 6.35% | 10.61s | <= 13.00s | 24.31s | 106.68s | <= 115.00s | Failed |
| WebKit | 100.00% | 0 | 0.00% | 11.04s | <= 14.00s | 29.18s | 104.97s | <= 120.00s | OK |
