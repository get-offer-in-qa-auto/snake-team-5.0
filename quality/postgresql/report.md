...
Period: **7 UTC calendar days** (2026-08-21T00:00:00+00:00 — 2026-08-27T14:22:16+00:00).
...
|---|---:|---:|---|---|
| Average Pass Rate | 97.96% | >= 98.00% | Failed | average pass rate = (96.10 + 98.70 + 97.40 + 97.40 + 100.00 + 96.10 + 100.00) / 7 = 97.96% |
| Average Fail Rate | 2.04% | <= 2.00% | Failed | average fail rate = (3.90 + 1.30 + 2.60 + 2.60 + 0.00 + 3.90 + 0.00) / 7 = 2.04% |
...
| Average UI Flaky Rate | 2.65% | <= 2.00% | Failed | average UI flaky rate = (3.70 + 0.00 + 7.41 + 7.41 + 0.00 + 0.00 + 0.00) / 7 = 2.65% |
...
| Average UI Test Duration | 10.28s | <= 12.00s | OK | average UI test duration = (9.86 + 9.74 + 10.81 + 10.25 + 10.40 + 11.39 + 9.55) / 7 = 10.28s |
| Average API Test Duration | 1.36s | <= 1.50s | OK | average API test duration = (1.36 + 1.41 + 1.36 + 1.44 + 1.38 + 1.16 + 1.41) / 7 = 1.36s |
| Total UI Test Time | 277.69s | <= 300.00s | OK | total UI test time = (266.24 + 262.88 + 291.99 + 276.77 + 280.76 + 307.44 + 257.78) / 7 = 277.69s |
| Average API Test Run Duration | 67.95s | <= 75.00s | OK | average API run duration = (67.77 + 70.31 + 67.91 + 71.93 + 69.17 + 58.05 + 70.49) / 7 = 67.95s |
| Average Pipeline Duration | 285.71s | <= 360.00s | OK | average pipeline duration = (293.00 + 303.00 + 301.00 + 298.00 + 260.00 + 276.00 + 269.00) / 7 = 285.71s |
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| Chromium | 95.24% | 3 | 3.17% | 8.70s | <= 11.00s | 21.33s | 92.66s | <= 100.00s | Failed |
| Firefox | 95.24% | 3 | 3.17% | 10.99s | <= 13.00s | 23.71s | 110.32s | <= 115.00s | Failed |
| WebKit | 95.24% | 3 | 1.59% | 11.16s | <= 14.00s | 28.43s | 116.11s | <= 120.00s | Failed |
