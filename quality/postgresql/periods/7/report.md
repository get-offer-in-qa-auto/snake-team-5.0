...
Period: **7 UTC calendar days** (2026-09-15T00:00:00+00:00 — 2026-09-21T07:46:47+00:00).
...
|---|---:|---:|---|---|
| Average Pass Rate | 99.07% | >= 98.00% | OK | average pass rate = (98.70 + 98.70 + 100.00 + 98.70 + 98.70 + 100.00 + 98.70) / 7 = 99.07% |
| Average Fail Rate | 0.93% | <= 2.00% | OK | average fail rate = (1.30 + 1.30 + 0.00 + 1.30 + 1.30 + 0.00 + 1.30) / 7 = 0.93% |
...
| Average UI Flaky Rate | 2.12% | <= 2.00% | Failed | average UI flaky rate = (3.70 + 3.70 + 0.00 + 3.70 + 0.00 + 0.00 + 3.70) / 7 = 2.12% |
...
| Average UI Test Duration | 9.67s | <= 12.00s | OK | average UI test duration = (9.56 + 7.74 + 10.71 + 10.58 + 9.14 + 10.95 + 8.99) / 7 = 9.67s |
| Average API Test Duration | 1.40s | <= 1.50s | OK | average API test duration = (1.42 + 1.39 + 1.41 + 1.43 + 1.36 + 1.41 + 1.42) / 7 = 1.40s |
| Total UI Test Time | 260.98s | <= 300.00s | OK | total UI test time = (258.07 + 209.07 + 289.07 + 285.67 + 246.65 + 295.55 + 242.79) / 7 = 260.98s |
| Average API Test Run Duration | 70.25s | <= 75.00s | OK | average API run duration = (71.16 + 69.45 + 70.32 + 71.29 + 68.04 + 70.55 + 70.92) / 7 = 70.25s |
| Average Pipeline Duration | 293.43s | <= 360.00s | OK | average pipeline duration = (383.00 + 267.00 + 257.00 + 321.00 + 281.00 + 267.00 + 278.00) / 7 = 293.43s |
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| Chromium | 98.41% | 1 | 0.00% | 8.74s | <= 11.00s | 23.93s | 91.49s | <= 100.00s | OK |
| Firefox | 93.65% | 4 | 6.35% | 9.64s | <= 13.00s | 21.75s | 106.68s | <= 115.00s | Failed |
| WebKit | 100.00% | 0 | 0.00% | 10.62s | <= 14.00s | 27.21s | 104.22s | <= 120.00s | OK |
