...
|---|---:|---:|---|---|
| Average Pass Rate | 99.63% | >= 98.00% | OK | average pass rate = (100.00 + 98.70 + 100.00 + 100.00 + 98.70 + 100.00 + 100.00) / 7 = 99.63% |
| Average Fail Rate | 0.37% | <= 2.00% | OK | average fail rate = (0.00 + 1.30 + 0.00 + 0.00 + 1.30 + 0.00 + 0.00) / 7 = 0.37% |
...
| Average UI Test Duration | 10.58s | <= 12.00s | OK | average UI test duration = (8.87 + 10.84 + 11.49 + 11.26 + 11.01 + 10.93 + 9.70) / 7 = 10.58s |
| Average API Test Duration | 1.39s | <= 1.50s | OK | average API test duration = (1.40 + 1.44 + 1.37 + 1.39 + 1.38 + 1.40 + 1.38) / 7 = 1.39s |
| Total UI Test Time | 285.78s | <= 300.00s | OK | total UI test time = (239.38 + 292.62 + 310.23 + 304.10 + 297.15 + 295.23 + 261.77) / 7 = 285.78s |
| Average API Test Run Duration | 69.68s | <= 75.00s | OK | average API run duration = (70.07 + 71.96 + 68.45 + 69.74 + 68.82 + 69.81 + 68.92) / 7 = 69.68s |
| Average Pipeline Duration | 336.57s | <= 360.00s | OK | average pipeline duration = (284.00 + 313.00 + 298.00 + 312.00 + 571.00 + 290.00 + 288.00) / 7 = 336.57s |
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| Chromium | 98.41% | 1 | 0.00% | 9.09s | <= 11.00s | 21.82s | 92.48s | <= 100.00s | OK |
| Firefox | 98.41% | 1 | 0.00% | 11.06s | <= 13.00s | 25.03s | 109.32s | <= 115.00s | OK |
| WebKit | 100.00% | 0 | 0.00% | 11.60s | <= 14.00s | 29.26s | 109.66s | <= 120.00s | OK |
