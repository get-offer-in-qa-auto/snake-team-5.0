...
|---|---:|---:|---|---|
| Average Pass Rate | 99.63% | >= 98.00% | OK | average pass rate = (98.70 + 100.00 + 100.00 + 98.70 + 100.00 + 100.00 + 100.00) / 7 = 99.63% |
| Average Fail Rate | 0.37% | <= 2.00% | OK | average fail rate = (1.30 + 0.00 + 0.00 + 1.30 + 0.00 + 0.00 + 0.00) / 7 = 0.37% |
...
| Average UI Test Duration | 10.75s | <= 12.00s | OK | average UI test duration = (10.84 + 11.49 + 11.26 + 11.01 + 10.93 + 9.70 + 10.00) / 7 = 10.75s |
| Average API Test Duration | 1.39s | <= 1.50s | OK | average API test duration = (1.44 + 1.37 + 1.39 + 1.38 + 1.40 + 1.38 + 1.38) / 7 = 1.39s |
| Total UI Test Time | 290.16s | <= 300.00s | OK | total UI test time = (292.62 + 310.23 + 304.10 + 297.15 + 295.23 + 261.77 + 270.02) / 7 = 290.16s |
| Average API Test Run Duration | 69.51s | <= 75.00s | OK | average API run duration = (71.96 + 68.45 + 69.74 + 68.82 + 69.81 + 68.92 + 68.84) / 7 = 69.51s |
| Average Pipeline Duration | 336.00s | <= 360.00s | OK | average pipeline duration = (313.00 + 298.00 + 312.00 + 571.00 + 290.00 + 288.00 + 280.00) / 7 = 336.00s |
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| Chromium | 98.41% | 1 | 0.00% | 9.36s | <= 11.00s | 22.58s | 92.48s | <= 100.00s | OK |
| Firefox | 98.41% | 1 | 0.00% | 11.24s | <= 13.00s | 25.03s | 109.32s | <= 115.00s | OK |
| WebKit | 100.00% | 0 | 0.00% | 11.64s | <= 14.00s | 28.66s | 110.55s | <= 120.00s | OK |
