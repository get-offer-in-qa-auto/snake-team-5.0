...
class AdminSteps(BaseSteps):
    ...
    def check_build_step_does_not_exist(
        ...
        CrudRequester(
            RequestSpecs.admin_auth_spec(),
            Endpoint.GET_BUILD_STEP,
            ResponseSpecs.request_returns_not_found_with_text(ResponseError.BUILD_STEP_NOT_FOUND),
        ).get(
            f"{build_configuration_locator}/steps/{step_id}",
        )
    ...
    def create_build_step_with_expected_error(
        ...
        CrudRequester(
            RequestSpecs.admin_auth_spec(),
            Endpoint.CREATE_BUILD_STEP,
            ResponseSpecs.request_returns_not_found_with_text(ResponseError.BUILD_CONFIGURATION_NOT_FOUND),
        ).post(
            build_step_request,
            path=f"{build_configuration_locator}/steps",
        )
