...
class AdminSteps(BaseSteps):
    ...
    def get_project(self, project_id: str) -> ProjectResponse:
        return ValidatedCrudRequester(
            ...
            ResponseSpecs.request_returns_ok(),
        ).get(TeamCityLocator.by_id(project_id))
    ...
    def delete_project(self, project_id: str):
        CrudRequester(
            ...
            ResponseSpecs.entity_was_deleted(),
        ).delete(TeamCityLocator.by_id(project_id))
    ...
    def get_build_configuration(
        ...
        return ValidatedCrudRequester(
            ...
            ResponseSpecs.request_returns_ok(),
        ).get(TeamCityLocator.by_id(build_configuration_id))
    ...
    def delete_build_configuration(self, build_configuration_id: str):
        CrudRequester(
            ...
            ResponseSpecs.entity_was_deleted(),
        ).delete(TeamCityLocator.by_id(build_configuration_id))
    ...
    def create_build_step(
        ...
        build_configuration_locator = TeamCityLocator.by_id(build_configuration_id)
