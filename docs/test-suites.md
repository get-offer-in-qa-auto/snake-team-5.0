...
и отмена running build. PostgreSQL CI использует 2 xdist worker и 2 отдельных
TeamCity agent, поэтому одновременно могут выполняться две независимые сборки.
